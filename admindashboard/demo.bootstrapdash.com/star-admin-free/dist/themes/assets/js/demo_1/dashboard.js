(function ($) {
  ...
  $(function () {
    ...
    if (document.getElementById('sales-statistics-overview')) {
      const salesChartCanvas = document.getElementById("sales-statistics-overview").getContext("2d");
      const gradientStrokeFill_1 = salesChartCanvas.createLinearGradient(0, 0, 0, 450);
      gradientStrokeFill_1.addColorStop(1, 'rgba(255,255,255, 0.0)');
      gradientStrokeFill_1.addColorStop(0, 'rgba(102,78,235, 0.2)');
      const gradientStrokeFill_2 = salesChartCanvas.createLinearGradient(0, 0, 0, 400);
      gradientStrokeFill_2.addColorStop(1, 'rgba(255, 255, 255, 0.01)');
      gradientStrokeFill_2.addColorStop(0, '#14c671');
    
      const data_1_1 = [60, 75, 65, 130, 130, 145, 110, 145, 155, 149, 170];
      const data_1_2 = [0, 25, 20, 40, 70, 52, 49, 90, 70, 94, 110, 135];
    
      const data_2_1 = [130, 145, 155, 60, 75, 65, 130, 110, 145, 149, 170];
      const data_2_2 = [0, 70, 52, 90, 25, 20, 40, 70, 49, 94, 110, 135];
    
      const data_3_1 = [130, 75, 65, 130, 110, 145, 155, 60, 145, 149, 170];
      const data_3_2 = [0, 70, 52, 94, 110, 135, 90, 25, 20, 40, 70, 49];
    
      const data_4_1 = [130, 145, 65, 130, 75, 145, 149, 170, 110, 155, 60];
      const data_4_2 = [0, 70, 90, 25, 40, 20, 94, 110, 135, 70, 49, 52];
      ...
      const salesChart = new Chart(salesChartCanvas, {
        ...
        plugins: [{
          id: 'customLegend',
          afterRender: (chart) => {
            document.getElementById('sales-statistics-legend').innerHTML = 
              areaOptions.plugins.customLegend.generateLegend(chart);
          }
        }]
      });
    
      document.getElementById('sales-statistics_switch_1').addEventListener('click', function () {
        salesChart.data.datasets[0].data = data_1_1;
        salesChart.data.datasets[1].data = data_1_2;
        salesChart.update();
      });
    
      document.getElementById('sales-statistics_switch_2').addEventListener('click', function () {
        salesChart.data.datasets[0].data = data_2_1;
        salesChart.data.datasets[1].data = data_2_2;
        salesChart.update();
      });
    
      document.getElementById('sales-statistics_switch_3').addEventListener('click', function () {
        salesChart.data.datasets[0].data = data_3_1;
        salesChart.data.datasets[1].data = data_3_2;
        salesChart.update();
      });
    
      document.getElementById('sales-statistics_switch_4').addEventListener('click', function () {
        salesChart.data.datasets[0].data = data_4_1;
        salesChart.data.datasets[1].data = data_4_2;
        salesChart.update();
      });
    }
    if ($("#net-profit").length) {
      ...
      var radarChart = new Chart(marksCanvas, {
        ...
        plugins: [{
          id: 'customLegend',
          afterRender: (chart) => {
            document.getElementById('net-profit-legend').innerHTML = 
              areaOptions.plugins.customLegend.generateLegend(chart);
          }
        }]
      });
    ...
    if (document.getElementById('total-revenue')) {
      const ctx = document.getElementById('total-revenue').getContext("2d");
      const data = {
        labels: Array.from({length: 82}, (_, i) => `Day${String(i + 1).padStart(2, '0')}`),
        datasets: [{
          label: 'Total Revenue',
    ...
    if (document.getElementById('total-transaction')) {
      const ctx = document.getElementById('total-transaction').getContext('2d');
      const gradientStrokeFill_1 = ctx.createLinearGradient(0, 100, 200, 0);
    ...
    if (document.getElementById("market-overview-chart")) {
      const MarketingChartCanvas = document.getElementById("market-overview-chart").getContext("2d");
      const Marketing_data_1_1 = [145, 238, 148, 293, 242, 235, 256, 334];
      const Marketing_data_1_2 = [330, 380, 230, 400, 309, 430, 340, 310];
      const Marketing_data_1_3 = [375, 440, 284, 450, 386, 480, 400, 365];
      const Marketing_data_1_4 = [425, 480, 324, 490, 426, 520, 440, 405];
    
      const Marketing_data_2_1 = [125, 138, 108, 193, 102, 200, 290, 204];
      const Marketing_data_2_2 = [330, 380, 230, 400, 309, 430, 340, 310];
      const Marketing_data_2_3 = [375, 440, 284, 450, 386, 480, 400, 365];
      const Marketing_data_2_4 = [425, 480, 324, 490, 426, 520, 440, 405];
    
      const MarketingChart = new Chart(MarketingChartCanvas, {
        type: 'bar',
        data: {
          labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug"],
          datasets: [{
      ...
      document.getElementById("market-overview_1").addEventListener('click', function () {
        const data = MarketingChart.data;
      ...
      document.getElementById("market-overview_2").addEventListener('click', function () {
        const data = MarketingChart.data;
      ...
      document.getElementById("market-overview_3").addEventListener('click', function () {
        const data = MarketingChart.data;
    ...
    if (document.getElementById("realtime-statistics")) {
      const realtimeChartCanvas = document.getElementById("realtime-statistics").getContext("2d");
      const realtimeChart = new Chart(realtimeChartCanvas, {
        type: 'bar',
        data: {
