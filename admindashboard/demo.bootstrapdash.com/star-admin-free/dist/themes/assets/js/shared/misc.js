...
var primaryColor = getComputedStyle(document.body).getPropertyValue('--bs-primary');
var secondaryColor = getComputedStyle(document.body).getPropertyValue('--bs-secondary');
var successColor = getComputedStyle(document.body).getPropertyValue('--bs-success');
var warningColor = getComputedStyle(document.body).getPropertyValue('--bs-warning');
var dangerColor = getComputedStyle(document.body).getPropertyValue('--bs-danger');
var infoColor = getComputedStyle(document.body).getPropertyValue('--bs-info');
var darkColor = getComputedStyle(document.body).getPropertyValue('--bs-dark');
var lightColor = getComputedStyle(document.body).getPropertyValue('--bs-light');
...
if ($('canvas').length && typeof Chart !== 'undefined' && Chart.defaults && Chart.defaults.global && Chart.defaults.global.tooltips) {
...
(function ($) {
  ...
  $(function () {
    ...
    $(document).ready(function () {
      ...
      $(document).on("click", "#sidebar > .nav > .nav-item > a[data-bs-toggle='collapse']", function () {
        // Hide any open collapses within the sidebar
