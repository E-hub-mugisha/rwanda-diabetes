...
<head>
    ...
    <style>
        :root {
            ...
            --color-foreground: #054468;
            --color-foreground-heading: #054468;
            ...
            --color-primary: #054468;
            --color-primary-background: #054468;
            --color-primary-hover: #054468;
            --color-primary-background-hover: #054468;
            ...
            --color-primary-button-icon: #054468;
            ...
            --color-primary-button-hover-icon-background: #054468;
            ...
            --color-secondary-button-hover-icon: #054468;
            ...
            --pagination-item-foreground: #054468;
            ...
            --pagination-item-active-background: #054468;
            --pagination-item-active-border: #054468;

            /* Swiper */
            --swiper-navigation-size: 14px;
            --swiper-navigation-color: #054468;
            --swiper-navigation-background-color: rgba(242, 242, 242, 1);
            --swiper-navigation-hover-color: #054468;
            --swiper-navigation-hover-background-color: transparent;
            --swiper-pagination-bullet-inactive-color: rgba(242, 242, 242);
            --swiper-pagination-color: #054468;
