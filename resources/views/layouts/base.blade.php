...
<head>
    ...
    <style>
        :root {
            ...
            --color-foreground: #197FC5;
            --color-foreground-heading: #197FC5;
            ...
            --color-primary: #197FC5;
            --color-primary-background: #197FC5;
            --color-primary-hover: #197FC5;
            --color-primary-background-hover: #197FC5;
            ...
            --color-primary-button-icon: #197FC5;
            ...
            --color-primary-button-hover-icon-background: #197FC5;
            ...
            --color-secondary-button-hover-icon: #197FC5;
            ...
            --pagination-item-foreground: #197FC5;
            ...
            --pagination-item-active-background: #197FC5;
            --pagination-item-active-border: #197FC5;

            /* Swiper */
            --swiper-navigation-size: 14px;
            --swiper-navigation-color: #197FC5;
            --swiper-navigation-background-color: rgba(242, 242, 242, 1);
            --swiper-navigation-hover-color: #197FC5;
            --swiper-navigation-hover-background-color: transparent;
            --swiper-pagination-bullet-inactive-color: rgba(242, 242, 242);
            --swiper-pagination-color: #197FC5;
