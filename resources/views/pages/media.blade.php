...
<div class="page-projects mt-100">
    <div class="container-fluid">
        <div class="row product-grid">
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/1.jpg" alt="project image" width="645" height="690" loading="lazy">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/2.jpg" alt="project image" width="645" height="690" loading="lazy">
                    <div class="card-project-content-absolute">
                        <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/3.jpg" alt="project image" width="645" height="690" loading="lazy">
                    <div class="card-project-content-absolute">
                        <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/4.jpg" alt="project image" width="645" height="690" loading="lazy">
                    <div class="card-project-content-absolute">
                        <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/5.jpg" alt="project image" width="645" height="690" loading="lazy">
                    <div class="card-project-content-absolute">
                        <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/6.jpg" alt="project image" width="645" height="690" loading="lazy">
                    <div class="card-project-content-absolute">
                        <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/7.jpg" alt="project image" width="645" height="690" loading="lazy">
                    <div class="card-project-content-absolute">
                        <div class="card-project-content">
            ...
            <div class="col-12 col-sm-6 col-lg-4 col-xl-3 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                <a class="card-project radius18" aria-label="project details" href="project-details.html">
                    <img src="assets/img/project/card/8.jpg" alt="project image" width="645" height="690" loading="lazy">
                    <div class="card-project-content-absolute">
                        <div class="card-project-content">
                            <h2 class="heading text-24">Business Development</h2>
                            <p class="text text-16">Digital marketing</p>
