            ...
            <div class="row product-grid">
                ...
                <div class="col-xl-4 col-md-6 col-12 aos-init aos-animate" data-aos="fade-up">
                    <div class="multicolumn-card">
                        ...
                        <h2 class="heading text-28">{{ $cat->name }}</h2>
                        ...
                        <a href="{{ route('research.category', $cat->slug) }}" class="button button--primary mt-3 w-100" aria-label="More About Us">
                            See all ({{ $cat->items()->count() }})
                            <svg viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg" style="height: 10px;">
...
<div class="pricing-plan pricing-plan-page mt-100 section-padding">
    <div class="media media-bg">
        <img src="assets/img/slider/slider-bg.jpg" alt="slider background" width="1920" height="100" loading="eager">
    </div>
    <div class="container">
