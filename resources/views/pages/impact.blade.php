    ...
    <div class="container">
        <div class="section-headings section-headings-horizontal">
            <div class="section-headings-left">
                <h2 class="heading text-64 fw-700 aos-init aos-animate" data-aos="fade-up">Our Impact, Trusted Advice, Proven Success</h2>
            ...
            <div class="section-headings-right">
                <div class="text-wrapper aos-init aos-animate" data-aos="fade-up">
                    ...
                    <div class="text text-18 fw-500">Years <br> of experience</div>
                </div>
        ...
        <div class="section-headings section-headings-horizontal">
            <div class="section-headings-left">
                ...
                <h2 class="heading text-50 aos-init aos-animate" data-aos="fade-right" data-aos-delay="20">
                    Our Impact, Trusted Advice, Proven Success
                </h2>
            </div>

            <div class="section-headings-right buttons aos-init aos-animate" data-aos="fade-left" data-aos-delay="20">
                <a href="#" class="button button--secondary" aria-label="hero button">
                    Latest Publications
                    <span class="svg-wrapper">
                        <svg class="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.3365 7.84518L6.16435 15.0173L4.98584 13.8388L12.158 6.66667H5.83652V5H15.0032V14.1667H13.3365V7.84518Z" fill="currentColor"></path>
            ...
            <div class="container">
                <service-slider class="service-slider">
                    <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                        <div class="swiper-wrapper" id="swiper-wrapper-701256a25e1398ae" aria-live="polite">
                            <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 5" style="width: 518.333px; margin-right: 20px;">
                                <a href="service-details.html" class="card-service radius18" aria-label="Service Card">
                                    <img src="assets/img/service/s3.jpg" alt="service image" width="1000" height="596" loading="lazy">
                                    <div class="card-service-content-absolute">
                                        <div class="card-service-content">
                                            <div class="card-working-process">
                                                <h2 class="heading text-24 fw-500">Empowering Young Researchers</h2>
                                                <div class="card-icon-text card-icon-text-horizontal">
                                                    ...
                                                    <div class="content">
                                                        <p class="text text-16">Over 120 young Rwandan researchers completed our mentorship bootcamp, gaining
                                                            advanced skills in epidemiology, data analysis, and scientific writing.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 5" style="width: 518.333px; margin-right: 20px;">
                                <a href="service-details.html" class="card-service radius18" aria-label="Service Card">
                                    <img src="assets/img/service/s4.jpg" alt="service image" width="1000" height="596" loading="lazy">
                                    <div class="card-service-content-absolute">
                                        <div class="card-service-content">
                                            <div class="card-working-process">
                                                <h2 class="heading text-24 fw-500">Digital Learning Reaching Rural Communities</h2>
                                                <div class="card-icon-text card-icon-text-horizontal">
                                                    <div class="svg-wrapper">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none">
                                                    ...
                                                    <div class="content">
                                                        <p class="text text-16">
                                                            Through offline-first digital modules, we supported 30+ health centers in rural areas
                                                            with access to reliable training materials.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="swiper-slide" role="group" aria-label="3 / 5" style="width: 518.333px; margin-right: 20px;">
                                <a href="service-details.html" class="card-service radius18" aria-label="Service Card">
                                    <img src="assets/img/service/s5.jpg" alt="service image" width="1000" height="596" loading="lazy">
                                    <div class="card-service-content-absolute">
                                        <div class="card-service-content">
                                            <div class="card-working-process">
                                                <h2 class="heading text-24 fw-500">Improving Diabetes Awareness</h2>
                                                <div class="card-icon-text card-icon-text-horizontal">
                                                    <div class="svg-wrapper">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" fill="none">
                                                    ...
                                                    <div class="content">
                                                        <p class="text text-16">
                                                            Community programs delivered in 12 districts improved early screening and patient
                                                            education for diabetes and NCDs.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
