        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-12">
                <div class="media-wrap" data-aos="zoom-in-up">
                    <img src="assets/img/image-text/img1.png" width="992" height="863" loading="lazy" alt="Image">
                </div>
            </div>
            <div class="col-lg-6 col-12">
    ...
    <div class="row flex-row-reverse">
        <div class="col-lg-5 col-12">
            <div class="service-content-image height-100 aos-init aos-animate" data-aos="zoom-out" data-aos-delay="100">
                <img src="assets/img/service/secvice-contact.jpg" width="1000" height="929" loading="lazy" alt="Service Image">
            </div>
        </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="content section-headings">
                            ...
                            <div class="text text-18 aos-init aos-animate" data-aos="fade-up">
                                We conduct nationwide campaigns, community trainings, and school programs to improve understanding of diabetes risk factors, symptoms, prevention, and long-term management.
                            </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="content section-headings">
                            <div class="subheading text-20 subheading-bg aos-init aos-animate" data-aos="fade-up">
                                ...
                                <span>Screening & Early Detection</span>
                                <svg class="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <g clip-path="url(#clip0_9088_4143)">
                                        <path d="M8.71401 5.28599C11.7514 5.4205 14 5.9412 14 7C14 8.0588 11.7514 8.5795 8.71401 8.71401C8.5795 11.7514 8.0588 14 7 14C5.9412 14 5.4205 11.7514 5.28599 8.71401C2.2486 8.5795 -1.33117e-07 8.0588 0 7C4.62818e-08 5.94119 2.2486 5.4205 5.28599 5.28599C5.4205 2.2486 5.9412 0 7 0C8.0588 0 8.5795 2.2486 8.71401 5.28599Z" fill="CurrentColor"></path>
                                    </g>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="content section-headings">
                            <div class="subheading text-20 subheading-bg aos-init aos-animate" data-aos="fade-up">
                                ...
                                <span>Treatment & Patient Support</span>
                                <svg class="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <g clip-path="url(#clip0_9088_4143)">
                                        <path d="M8.71401 5.28599C11.7514 5.4205 14 5.9412 14 7C14 8.0588 11.7514 8.5795 8.71401 8.71401C8.5795 11.7514 8.0588 14 7 14C5.9412 14 5.4205 11.7514 5.28599 8.71401C2.2486 8.5795 -1.33117e-07 8.0588 0 7C4.62818e-08 5.94119 2.2486 5.4205 5.28599 5.28599C5.4205 2.2486 5.9412 0 7 0C8.0588 0 8.5795 2.2486 8.71401 5.28599Z" fill="CurrentColor"></path>
                                    </g>
                            ...
                            <div class="text text-18 aos-init aos-animate" data-aos="fade-up">
                                We work with hospitals and health centers to support ongoing diabetes management, including follow-up care, counseling, and navigation for young people and adults.
                            </div>
                            <div class="buttons aos-init aos-animate" data-aos="fade-up">
                                <a href="project.html" class="button button--primary" aria-label="More About Us">
                                    Learn More
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="content section-headings">
                            <div class="subheading text-20 subheading-bg aos-init aos-animate" data-aos="fade-up">
                                ...
                                <span>Community Outreach & Advocacy</span>
                                <svg class="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <g clip-path="url(#clip0_9088_4143)">
                                        <path d="M8.71401 5.28599C11.7514 5.4205 14 5.9412 14 7C14 8.0588 11.7514 8.5795 8.71401 8.71401C8.5795 11.7514 8.0588 14 7 14C5.9412 14 5.4205 11.7514 5.28599 8.71401C2.2486 8.5795 -1.33117e-07 8.0588 0 7C4.62818e-08 5.94119 2.2486 5.4205 5.28599 5.28599C5.4205 2.2486 5.9412 0 7 0C8.0588 0 8.5795 2.2486 8.71401 5.28599Z" fill="CurrentColor"></path>
                                    </g>
                            ...
                            <div class="text text-18 aos-init aos-animate" data-aos="fade-up">
                                We engage local leaders, families, and stakeholders to build supportive environments for people living with diabetes—driving policy change and strengthening health systems.
                            </div>
                            <div class="buttons aos-init aos-animate" data-aos="fade-up">
                                <a href="project.html" class="button button--primary" aria-label="More About Us">
                                    Learn More
            ...
            <div class="col-lg-6 col-12">
                <div class="section-headings">
                    ...
                    <div class="text text-18" data-aos="fade-up" data-aos-delay="80">
                        ...
                        It's all about making sure that the user interface.
                    </div>
                    ...
                    <div class="image-absolute" data-aos="zoom-in">
                        <img src="assets/img/faq/question.png" width="104" height="180" loading="lazy" alt="Image">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-12">
                        ...
                        <div class="accordion-block" data-aos="fade-up">
                            ...
                            <div class="accordion-content">
                                <div class="accordion-content-inner text text-18">
                                    Nor is there anyone who loves or pursues or desires to obtain pain itself, because it is pain, but
                                    occasionally cumstances occur in which toil and pain can procuresteady steady.
