        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-12">
                <div class="media-wrap" data-aos="zoom-in-up">
                    <img src="assets/img/image.png" width="992" height="863" loading="lazy" alt="Image">
                </div>
            </div>
            <div class="col-lg-6 col-12">
    ...
    <div class="row flex-row-reverse">
        <div class="col-lg-5 col-12">
            <div class="service-content-image height-100 aos-init aos-animate" data-aos="zoom-out" data-aos-delay="100">
                <img src="assets/img/image.png" width="1000" height="929" loading="lazy" alt="Service Image">
            </div>
        </div>
