                        ...
                        <div class="card-icon-text card-icon-text-horizontal" data-aos="fade-up">
                            ...
                            <div class="content">
                                ...
                                <p class="text text-20">
                                    123 King Street West, Toronto, Canada.
                                </p>
                            </div>
                        </div>
                        <div class="card-icon-text card-icon-text-horizontal" data-aos="fade-up">
                        ...
                        <div class="accordion-block" data-aos="fade-up">
                            ...
                            <div class="accordion-content">
                                <div class="accordion-content-inner text text-18">
                                    Nor is there anyone who loves or pursues or desires to obtain pain itself, because it is pain, but occasionally cumstances occur in which toil and pain can procuresteady steady.
